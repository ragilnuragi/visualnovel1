...
#define config.name = _("Cerita Anak SMA")
...
define build.name = "keharmonisan-kode-kode-lucu"
...
define config.main_menu_music = "audio/lagu.mp3"
...
define config.window_title = "Keharmonisan Kode-Kode Lucu"
...
define config.save_directory = "vava-1686783026"
...
define config.window_icon = "gui/icon_game.png"
...
init python:
    ...
    build.name = "Keharmonisan-Kode-Kode-Lucu"
